...
export default function AutorizacionPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <div className="border p-4 rounded mb-6 text-sm space-y-2">
        <p><strong>✔ Tú sigues siendo el autor</strong></p>
        <p><strong>✔ No cedes derechos</strong></p>
        <p><strong>✔ Puedes pedir eliminación</strong></p>
        <p><strong>✔ Uso educativo únicamente</strong></p>
      </div>
