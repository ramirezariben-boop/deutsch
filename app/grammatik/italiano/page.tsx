...
const sections = [
  {
    title: "Pronuncia",
    buttons: [{ name: "Pronuncia", href: "/grammatik/italiano/pronuncia.html" }],
  },
  {
    title: "Génere",
    buttons: [
      { name: "Génere I",  href: "/grammatik/italiano/genere.html" },
      { name: "Génere II", href: "/grammatik/italiano/genere-2.html" },
    ],
  },
  {
    title: "Verbi",
    buttons: [
      { name: "Coniugazione", href: "/grammatik/italiano/coniugazione.html" },
      { name: "Irregolari",   href: "/grammatik/italiano/irregolari.html" },
    ],
  },
  {
    title: "Terminazioni",
    buttons: [{ name: "Terminazioni", href: "/grammatik/italiano/terminazioni.html" }],
  },
];
